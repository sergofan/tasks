...
(function(document) {
	...
	window.addEventListener('WebComponentsReady', function() {
		...
		mquery.fire('query-matches-changed');
		...
		addEventListener('paper-header-transform', function(e) {
			...
			Polymer.Base.transform('scale(' + scale + ') translateZ(0)', appNameContainer);
		});
	});
